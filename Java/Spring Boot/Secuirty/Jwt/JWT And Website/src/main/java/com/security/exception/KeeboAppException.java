...
public class KeeboAppException extends Exception {
	...
	public KeeboAppException(Exception e) {
		super(e.getMessage());
	}

	public KeeboAppException(String message) {
		super(message);
	}

	public KeeboAppException(int code, String message) {
		super(message);
		this.code = code;
	}

	public KeeboAppException(int code, String message, String developerMessage) {
		super(message);
		this.code = code;
		this.developerMessage = developerMessage;
	}

	public KeeboAppException(int code, String message, String messageDescription, int errorCodeValue) {
		super(message);
		this.code = code;
